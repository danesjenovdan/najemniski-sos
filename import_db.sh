...
DATABASE_NAME="najemniski_sos"
K8S_NAMESPACE="najemniski-sos"
SECRETS_NAME="najemniski-sos-credentials"
...
# docker container exec -i $(docker compose ps -q db) psql -U najemniski_sos najemniski_sos < db.dump
